...
def read_codepage(text, codepage='cp437'):
    """
    Keep only characters belonging to the character set of a language
    Args: 
    -- text: input text
    -- code page: for each language.
    Example: Code page 437 is the original code page of the IBM PC.
    https://www.ascii-codes.com/cp437.html
    """
...
def run_cleaner():
    ...
    parser.add_argument('--rm_new_lines', '-r', action='store_true', help='Remove new lines')
